...
if __name__ == '__main__':
    ...
    # Training loop for convolution percentage timing
    # def train_and_validate_model():
    #     model.train()
    ...
    #         print(f'Epoch {epoch+1}, Training Loss: {loss.item()}, Validation Loss: {val_loss}')
    #         scheduler.step()
    #     return total_training_time_start

    # total_training_time_start = train_and_validate_model()

    # total_training_time = time.time() - total_training_time_start
    # print(f'Total training time: {total_training_time}s')
    # print(f'Total time in conv operations: {model.up.conv_time}s')
    # print(f'Percentage of time in conv operations: {(model.up.conv_time / total_training_time) * 100:.2f}%')
